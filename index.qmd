...
report:
  ...
  expansion: "Companion to the CLEER Technical Report"
...
<div class="saig-cover" style="background: linear-gradient(135deg, #f5f1e9 0%, #e7f2f2 60%, #f7e6d9 100%);">
  <div class="saig-cover-top">
    <div class="saig-logo-card"><strong>SUSTAINABLE AI GROUP</strong></div>
...
#place(top + left, dx: 0pt, dy: 0pt)[
  #rect(width: 8.5in, height: 11in, fill: rgb("#F5F1E9"))
]

#place(top + left, dx: 0.52in, dy: 0.66in)[
  #block(width: 3.48in, fill: white, radius: 11pt, inset: 12pt)[
    #text(font: "Inter", size: 13pt, weight: "bold", fill: rgb("#033845"))[SUSTAINABLE AI GROUP]
  ]
]
...
#place(top + left, dx: 0.58in, dy: 3.03in)[
  #text(font: "Inter", size: 35pt, weight: "medium", fill: rgb("#B8663B"))[{{< meta report.title >}}]
]

#place(top + left, dx: 0.58in, dy: 4.08in)[
  #text(font: "DM Mono", size: 18pt, tracking: 0.8pt, fill: rgb("#B8663B"))[[{{< meta report.expansion >}}]]
]

#place(top + left, dx: 0.58in, dy: 5.00in)[
  #block(width: 6.90in)[
...
We note that AI emissions accounting remains an emerging field: serving architectures and provider disclosures evolve faster than the published research, and the evidence supporting some factors remains limited. We identify these limitations where they arise and will update the calculation as better data becomes available. All factor changes will be recorded in Annex F. Feedback, corrections and additional data are welcome through the public repository.
...
: Adopted factors. Values apply to the central calculation; sensitivities are reported in §11. {#tbl-adopted-factors-values-apply-to-the-central-calculatio}

## 1.4 Calculation Chain

![Calculation chain from customer token activity to the reported greenhouse gas inventory footprint.](assets/fig-calculation-chain.svg){#fig-calculation-chain width=100%}

The calculation distinguishes customer activity data, modelled accelerator energy, proxy and default factors, and calculated emissions. These categories are retained through the factor register and assurance process.
...
: AI terms and their GHG accounting analogues. {#tbl-ai-terms-and-their-ghg-accounting-analogues}
...
: Sources included in the system boundary. {#tbl-sources-included-in-the-system-boundary}
...
: Sources excluded from the system boundary. Derivations are in Annex A. {#tbl-sources-excluded-from-the-system-boundary-derivations}
...
: Activity-data hierarchy. {#tbl-activity-data-hierarchy}
...
: Evidence for non-accelerator power and implied host multipliers. {#tbl-evidence-for-non-accelerator-power-and-implied-host-mu}
...
: Hierarchy for selecting the PUE factor. {#tbl-hierarchy-for-selecting-the-pue-factor}
...
: Adopted factors for converting accelerator energy to facility energy. {#tbl-adopted-factors-for-converting-accelerator-energy-to-f}
...
: Hierarchy for selecting the electricity carbon-intensity factor. {#tbl-hierarchy-for-selecting-the-electricity-carbon-intensi}
...
| Technology | LHV efficiency | Emission factor | Share of generation |
| :---- | :---- | :---- | :---- |
| Gas turbines, simple cycle | 38% | 0.70 kgCO₂e/kWh | 35.3% |
| Reciprocating engines | 45% | 0.73 kgCO₂e/kWh | 32.3% |
| Combined cycle (gas turbine and steam) | 55% | 0.49 kgCO₂e/kWh | 26.0% |
| Solid oxide fuel cells | 54% | 0.49 kgCO₂e/kWh | 5.1% |
| Other or undisclosed | Fleet average | 0.64 kgCO₂e/kWh | 1.3% |
| **Fleet blended** | **—** | **0.64 kgCO₂e/kWh** | **100.0%** |
: Behind-the-meter technology mix and emission factors. {#tbl-behind-the-meter-technology-mix-and-emission-factors}
...
| **Applied value** |  | **1.5** |
: Evidence supporting the default model-development ratio. {#tbl-evidence-supporting-the-default-model-development-rati}
...
: Footprint by reporting use. {#tbl-footprint-by-reporting-use}
...
: Alignment with GHG Protocol Scope 3 and ICT Sector Guidance. {#tbl-framework-ghg-protocol}
...
: Alignment with ITU-T L.1801. {#tbl-framework-itu}
...
: Alignment with GSF SCI for AI. {#tbl-framework-gsf}
...
: Alignment with Watershed AI emissions framework. {#tbl-framework-watershed}
...
: Symbols and units. {#tbl-symbols-and-units}
...
: Sources relied upon and their principal uses. {#tbl-sources-relied-upon-and-their-principal-uses}
